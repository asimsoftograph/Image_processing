...
def process_image(path, mode="gray", threshold_value=127, low_thresh=100, high_thresh=200):
    ...
    if mode == "gray":
        ...
        cv2.imwrite(out_path, contours_img)
    elif mode == "watermark":
        ...
        # Default: save original
        cv2.imwrite(out_path, img)

    return out_path

# def process_image_full(path, threshold_value=127, low_thresh=100, high_thresh=200):
#     if not os.path.exists("processed"):
#         os.makedirs("processed")
